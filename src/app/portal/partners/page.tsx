...
import { Handshake } from 'lucide-react'; // Icon for Partners
...
export default function PartnersPage() {
  ...
  return (
    // For now, protect with 'employee'. If Partners have a distinct role, update here.
        ...
        <main className="flex flex-1 flex-col items-center justify-center p-6">
          <Card className="w-full max-w-2xl text-center shadow-xl">
            <CardHeader>
              ...
              <CardTitle className="text-4xl font-headline text-primary">Cổng Thông Tin Đối Tác</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-lg text-muted-foreground">
                Chào mừng bạn đến với cổng thông tin dành cho đối tác của TechCorp.
              </p>
              {userProfile && (

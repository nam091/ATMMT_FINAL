...
import { Code2 } from 'lucide-react'; // Icon for Engineering
...
export default function EngineeringPage() {
  ...
  useEffect(() => {
    setMounted(true);
    console.log("EngineeringPage mounted");
  }, []);
        ...
        <main className="flex flex-1 flex-col items-center justify-center p-6">
          <Card className="w-full max-w-2xl text-center shadow-xl">
            <CardHeader>
              ...
              <CardTitle className="text-4xl font-headline text-primary">Trang Nhóm Engineering</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-lg text-muted-foreground">
                Chào mừng bạn đến với không gian làm việc của nhóm Engineering.
              </p>
              {userProfile && (
